...
const CreatePDFVertical4 = () => {
    ...
    return (
        ...
        <div className="upper-container-one">
            ...
            {formData.descripcion3 && <button id="cancel-description-1-one" className='cancel-button-for-vertical-one' onClick={() => handleInputChange({ target: { name: 'descripcion3', value: '' } })}>X</button>}
            <input type="text" maxLength={65} placeholder="Descrip imagen (opcional)" className='description-text-two' name="descripcion4" value={formData.descripcion4} onChange={handleInputChange} />
            {formData.descripcion4 && <button id="cancel-description-2-one" className='cancel-button-for-vertical-one' onClick={() => handleInputChange({ target: { name: 'descripcion4', value: '' } })}>X</button>}
            </div>
...
export default CreatePDFVertical4;
